...
#     """Load and return text from a PDF"""
...
#         Cleans up CID patterns and improves text extraction.
        
#         Args:
#             file_path: Path to the PDF file
            
#         Returns:
#             Combined text from all pages of the PDF with cleaned up formatting
#         """
#         try:
#             text_content = []
#             with pdfplumber.open(file_path) as pdf:
#                 for page in pdf.pages:
#                     # Extract text with better handling of character encoding
...
#         Returns:
#             Extracted text from the first page of the PDF with cleaned up formatting
#         """
#         try:
#             with pdfplumber.open(file_path) as pdf:
